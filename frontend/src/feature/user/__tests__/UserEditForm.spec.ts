...
class RecordingUserRepository implements IUserRepository {
	...
	createUser(username: string, password: string, role: model.UserRole): Promise<void> {
		throw new Error("Method not implemented.");
	}
